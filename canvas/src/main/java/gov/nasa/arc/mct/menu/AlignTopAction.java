...
public class AlignTopAction extends ContextAwareAction {
    private static final long serialVersionUID = 1L;
    public static final String ACTION_KEY = "CANVAS_OBJECTS_ALIGNMENT_TOP";

    private List<Panel> selectedPanels;
    private static final ResourceBundle BUNDLE = 
        ResourceBundle.getBundle(
                        AlignTopAction.class.getName().substring(0, 
                                        AlignTopAction.class.getName().lastIndexOf("."))+".Bundle");
    
    
    public AlignTopAction() {
        super(BUNDLE.getString("AlignTopAction.Label"));
    }
