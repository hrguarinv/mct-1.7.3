...
/**
 * This interface provides access for provider delegate service.
 ...
 *    ServiceReference ref = bc.getServiceReference(ProviderDelegateService.class.getName());
 *    if (ref != null) 
 *      ProviderDelegateService service = (ProviderDelegateService) bc.getService(ref);
 *    ...
 ...
 */
public interface ProviderDelegateService {
    
    /**
     * Returns the provider delegates provided by <code>ComponentProvider</code>s. 
