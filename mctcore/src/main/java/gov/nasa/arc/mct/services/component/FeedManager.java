...
/**
 * This interface provides access for feed management.
 ...
 *    ServiceReference ref = bc.getServiceReference(FeedManager.class.getName());
 *    if (ref != null) 
 *      FeedManager feedManager = (FeedManager) bc.getService(ref);
 *    ...
