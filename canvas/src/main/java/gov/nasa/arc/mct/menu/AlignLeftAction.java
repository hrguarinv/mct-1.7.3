...
public class AlignLeftAction extends ContextAwareAction {
    private static final long serialVersionUID = 1L;
    public static final String ACTION_KEY = "CANVAS_OBJECTS_ALIGNMENT_LEFT";

    private List<Panel> selectedPanels;
    private static final ResourceBundle BUNDLE = 
        ResourceBundle.getBundle(
                        AlignLeftAction.class.getName().substring(0, 
                                        AlignLeftAction.class.getName().lastIndexOf("."))+".Bundle");
    
    
    public AlignLeftAction() {
        super(BUNDLE.getString("AlignLeftAction.Label"));
    }
