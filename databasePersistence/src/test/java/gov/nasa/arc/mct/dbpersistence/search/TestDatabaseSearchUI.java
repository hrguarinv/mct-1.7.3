...
import gov.nasa.arc.mct.dbpersistence.search.DatabaseSearchUI;
...
public class TestDatabaseSearchUI {
    ...
    public void setup() {
        ...
        GuiActionRunner.execute(new GuiTask() {
            ...
            protected void executeInEDT() throws Throwable {
                ...
                frame.setContentPane(platformSearchUI);
                frame.pack();
    ...
    public void testSearchClickResults() {
        ...
        Condition condition = new Condition("Results Arrived.") {
            ...
            @Override
            protected void done() {
                AssertJUnit.assertEquals(list.target.getModel().getSize(), 2);
            }
    ...
    private class MockPlatformSearchUI extends DatabaseSearchUI {
