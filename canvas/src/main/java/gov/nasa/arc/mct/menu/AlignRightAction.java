...
public class AlignRightAction extends ContextAwareAction {
    private static final long serialVersionUID = 1L;
    public static final String ACTION_KEY = "CANVAS_OBJECTS_ALIGNMENT_RIGHT";

    private List<Panel> selectedPanels;
    private static final ResourceBundle BUNDLE = 
        ResourceBundle.getBundle(
                        AlignRightAction.class.getName().substring(0, 
                                        AlignRightAction.class.getName().lastIndexOf("."))+".Bundle");
    
    
    public AlignRightAction() {
        super(BUNDLE.getString("AlignRightAction.Label"));
    }
