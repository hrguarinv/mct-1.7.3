...
/**
 * Implements a label which is optimized for rendering inside a table cell. An
...
public class LightweightPanel extends JPanel {
	
	/**
	 * Creates a lightweight panel that is initially opaque.
	 */
