...
public class PlatformAccessTest {
    ...
    public void testGetPlatform() {        
        Assert.assertNull(PlatformAccess.getPlatform());
    }
    
    @Test(dependsOnMethods="testGetPlatform")
    public void testSetPlatform() {   
        PlatformAccess access = new PlatformAccess();
        access.setPlatform(platform);
        Assert.assertSame(PlatformAccess.getPlatform(), platform);
    }
    
    @Test(dependsOnMethods="testSetPlatform")
    public void testReleasePlatform() {        
        PlatformAccess access = new PlatformAccess();
