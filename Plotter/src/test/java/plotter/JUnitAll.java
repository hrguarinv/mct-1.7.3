...
import plotter.internal.JUnitInternal;
import plotter.xy.JUnitXY;
...
public class JUnitAll extends TestSuite {
	public static TestSuite suite() {
		...
		suite.addTestSuite(JUnitLogTickMarkCalculator.class);
		suite.addTestSuite(JUnitTimeTickMarkCalculator.class);
		suite.addTest(JUnitInternal.suite());
		suite.addTest(JUnitXY.suite());
		return suite;
	}
}
