...
public class ExecutableButtonThisAction extends ContextAwareAction {

	private static final Logger logger = LoggerFactory.getLogger(ExecutableButtonThisAction.class);
	...
	public ExecutableButtonThisAction() {
