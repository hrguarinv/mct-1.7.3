...
public class WindowGridMenu extends ContextAwareMenu {
    private static final long serialVersionUID = -567011915276411769L;

    private static ResourceBundle bundle = ResourceBundle.getBundle(WindowGridMenu.class.getName().substring(0, 
                    WindowGridMenu.class.getName().lastIndexOf("."))+".Bundle");

    private static final String GRID_TEXT = bundle.getString("Grids");
    
    public static final String VIEW_GRID_SIZE_SUBMENU_EXT = "/view/formatting.ext/sizes.ext";

    public WindowGridMenu() {
        super(GRID_TEXT);
    }
