...
public class AlignBottomAction extends ContextAwareAction {
    private static final long serialVersionUID = 1L;
    public static final String ACTION_KEY = "CANVAS_OBJECTS_ALIGNMENT_BOTTOM";

    private List<Panel> selectedPanels;
    private static final ResourceBundle BUNDLE = 
        ResourceBundle.getBundle(
                        AlignBottomAction.class.getName().substring(0, 
                                        AlignBottomAction.class.getName().lastIndexOf("."))+".Bundle");
    
    
    public AlignBottomAction() {
        super(BUNDLE.getString("AlignBottomAction.Label"));
    }
