...
/** Class to create a multi component via a UI "wizard"
 * @author dcberrio
 *
 */
public class MultiWizardUI  extends CreateWizardUI{
	...
	public MultiWizardUI() {
		this.componentClass = MultiComponent.class;
	}
	...
	public JComponent getUI(final JButton create) {
		...
		language = new JComboBox (new String [] {MultiEvaluator.LANGUAGE_STRING});
