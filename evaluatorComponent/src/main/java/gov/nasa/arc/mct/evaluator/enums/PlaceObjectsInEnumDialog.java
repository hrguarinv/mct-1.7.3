...
/**
 * Show dialog box for associating objects with a new enum.
 */
@SuppressWarnings("serial")
public class PlaceObjectsInEnumDialog extends JDialog {
    ...
    static {
        errorMessage = "Enumerator name must contain" + " " + MIN_LENGTH
    ...
    /**
     * Place enumerator objects in new collection dialog window. 
     * @param frame the Frame.
     * @param selectedComponentNames selective component names.
     */
    public PlaceObjectsInEnumDialog(Frame frame, String [] selectedComponentNames) {
        super(frame, ModalityType.DOCUMENT_MODAL);
        
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        
        setTitle("Place Objects in New Enumerator" + " - " + frame.getTitle());
        
        JLabel prompt = new JLabel(bundle.getString("DialogPrompt"));
        name.setText("untitled enumerator");
        name.selectAll();
        ...
        create.addActionListener(new ActionListener() { 
            ...
            public void actionPerformed(ActionEvent arg0) {
            	PlaceObjectsInEnumDialog.this.setVisible(false);
            	PlaceObjectsInEnumDialog.this.dispose();
            	confirmed = true;
            }
        });
        ...
        //Displays what telemetry elements are associated with the new enum
    ...
    /**
     * Gets the confirmed enum name.
     * @return the enum name.
     */
    public String getConfirmedEnumName() {
        if (confirmed)
