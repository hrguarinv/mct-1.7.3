...
/**
 * This class defines the policy for changing ownership of a group.
 * 
 * @author nshi
 *
 */

public class ChangeOwnershipPolicy implements Policy{
    ...
    private boolean canChangeOwnership(AbstractComponent component) {
        return RoleAccess.canChangeOwner(component, PlatformAccess.getPlatform().getCurrentUser());
    }
}
