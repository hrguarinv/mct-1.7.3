...
public class AlignHorizontalCenterAction extends ContextAwareAction {
    private static final long serialVersionUID = 1L;

    public static final String ACTION_KEY = "CANVAS_OBJECTS_HORIZONTAL_ALIGNMENT_CENTER";
    ...
    public AlignHorizontalCenterAction() {
        super(BUNDLE.getString("AlignHorizontalCenterAction.Label"));
    }
